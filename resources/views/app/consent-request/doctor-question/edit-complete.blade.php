           ...
           <div class="columns is-variable is-8">
               ...
               <div class="column">
                   ...
                   <div class="tab-content">
                       ...
                       <h3 class="title is-4">Your Answers</h3>

                       <p>This consent request has been completed previously. </p>
                       <p><a href="{{ url('app/consent-requests/'.$consentRequest->id) }}"> Go to the completed consent request.</a> </p>
